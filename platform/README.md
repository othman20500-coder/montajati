...
قائمة المراجعة (`/api/v1/reviews/queue`) = الشواهد التي فُحصت عبر WebFetch أو صور الصفحات أو OCR أو PDF: 57 شاهدًا من حزمة v1.2، ويُضاف إليها كل شاهد في الملحقات فُحص بقراءة بصرية (منذ 2026-09-25: 11 شاهدًا بقراءة بصرية و15 بنص OCR مراجع بصريًا من مسح «تاريخ افتتاح الأندلس» لابن القوطية)، فالمجموع 83.
