...
- التصدير يضم أيضًا `ATLAS` (طبقات `atlas_layers` وأعضاؤها، مظاريف `atlas_zones` بوسمها الكارتوغرافي، سياسة الإصدار، مصادر الحدود المرشحة، ومجموعات إسنادات كل نموذج) لواجهة الأطلس الموحّد في `andalus/index.html#/atlas`، المبنية مكوّناتٍ بالاسترشاد بالنموذج المرجعي دون نسخه.
